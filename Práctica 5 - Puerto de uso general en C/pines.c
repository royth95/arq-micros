	...
	*pReloj=0x3E00; 	// Habilito el reloj de todos los puertos
	...
	switch(puerto)
	{
		case 'A':  PDDR_A=0x400FF014;
						...
						PCR_A=0x40049000; // habilitar el PCR
						if (pin<1)
						{
							*PCR_A=0x100;
						}
